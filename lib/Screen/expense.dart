...
class _ExpenseScreenState extends State<ExpenseScreen> {
  ...
  void _calculateTotal() {
    setState(() {
      ...
      _totalExpenseAmount = _filteredTransactions.fold(
        0.0,
  ...
  Future<void> _fetchCategories() async {
    List<Category> fetchedCategories = await FirebaseService.getAllCategories();
    setState(() {
      _categoriesMap = {
  ...
  Future<void> _fetchExpenses() async {
    ...
    setState(() {
      _allTransactions = expenses;
      _filteredTransactions = expenses;
      _calculateTotal();
    });
  }
